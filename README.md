...
```sh
cargo install --git https://github.com/laleshii/birdman --tag v0.1.4 birdman-daemon
cargo install --git https://github.com/laleshii/birdman --tag v0.1.4 birdman-cli
cargo install --git https://github.com/laleshii/birdman --tag v0.1.4 birdman-ui   # desktop app
```
...
```sh
git clone --branch v0.1.4 https://github.com/laleshii/birdman
cd birdman
